...
public class ConfigSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable();
        http.authorizeRequests().antMatchers("/productPage", "/calibrationPage", "/dischargePage", "/recipePage", "/service/export/excel/**", "/api/v1/**", "/role-action").access("hasAnyRole('ROLE_ACCOUNTMANAGER', 'ROLE_TECHNOLOGIST')");
