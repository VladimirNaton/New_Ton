...
public interface RawRepository extends JpaRepository<RawEntity, Integer> {
    ...
    @Query("select new com.new_ton.domain.dto.GetDataForSelectedRowEditeRecipeTableResponseDto(r.id, r.n, r.stage, r.nameraw, r.percent, r.mass, r.devper, r.devmass, r.turnmix, r.timemix, r.pastpart, r.pastdate, r.filter) from RawEntity r where r.id =?1")
